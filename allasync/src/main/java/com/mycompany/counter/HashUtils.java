...
public class HashUtils {
    ...
    public static int[] sha1Offset(long bizId, int hashFunctionCount,
            int maxBitCount) {
        int[] offsets = new int[hashFunctionCount];
        byte[] sha1;
        sha1 = DigestUtils.sha(String.valueOf(bizId));
    ...
    public static int[] murmurHashOffset(long bizId, int hashFunctionCount,
            int maxBitCount) {
        int[] offsets = new int[hashFunctionCount];
